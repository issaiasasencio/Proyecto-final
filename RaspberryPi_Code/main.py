    ...
    while True:
        ...
        for r in results:
            for box in r.boxes:
                ...
                cv2.putText(frame, f"{nombre} {box.conf[0]:.2f}", (x1, y1-5),
                ...
                if en_cinta and en_zona:
                    ...
                    if servo_id_str in ['1', '2', '3', '4']:
                        ...
                        if (current_time - ultimo) > TIEMPO_COOLDOWN:
                            ...
                            print(
                                f">>> [ZONA] {nombre}. Activa Servo {servo_id_str}. Tiempo viaje restante: {t_viaje - TIEMPO_ANTICIPACION:.2f}s")
